...
public class ReplaceStepOption implements Option {
	String text = "Replace Step";
	Recipe recipe;
	
	
	public ReplaceStepOption(Recipe r) {
		this.recipe = r;
	}
	...
	public void executeOption(Interface inter, Scanner lector, Menu prevMenu) {
		...
		System.out.println("What step do you want to replace?");
		...
		regInterface.replaceStep(time, cadena, stepPos-1, recipe);
	}
